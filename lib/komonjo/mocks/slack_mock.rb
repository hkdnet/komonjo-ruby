  ...
  module Mock
    ...
    class SlackMock
      class << self
        ...
        def users_list
          [
            { id: 'id001', name: 'name001', deleted: false, profile: { image_48: '' } },
            { id: 'id002', name: 'name002', deleted: false, profile: { image_48: '' } }
          ]
        end
          ...
          [
            {
              ...
              'topic': { 'value': 'Fun times', 'creator': 'U024BE7LV', 'last_set': 1_369_677_212 },
              'purpose': {
                'value': 'This channel is for fun', 'creator': 'U024BE7LH', 'last_set': 1_360_782_804
              },
              'is_member': true,
              ...
              'members': %w(U024BE7LH U024BE7LH),
              'topic': { 'value': 'Fun times', 'creator': 'U024BE7LV', 'last_set': 1_369_677_212 },
              'purpose': { 'value': 'This channel is for fun', 'creator': 'U024BE7LH', 'last_set': 1_360_782_804 },
              'is_member': true,
              'last_read': '1401383885.000061',
              'latest': { 'hoge': 'fuga' },
              'unread_count': 0,
